...
from TourApp.views.usuarioViewSet import CrearUsuarioViewSet, DetalleUsuarioView, EditarUsuarioView, EliminarUsuarioView, ListarUsuarioView
from TourApp.views.tourViewSet import TourCiudadGetView, TourIdGetView, TourViewSet
from TourApp.views.ciudadViewSet import CiudadGetView, CiudadView
from TourApp.views.carritoViewSet import CarritoGetView, CarritoView, EditarCarritoView, EliminarCarritoView
from TourApp.views.compraViewSet import CompraView, CompraIdGetView
